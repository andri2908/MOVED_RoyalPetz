...
CREATE TABLE `cashier_log` (
  ...
  `TOTAL_CASH_TRANSACTION` double(15,2) DEFAULT '0',
  `TOTAL_NON_CASH_TRANSACTION` double(15,2) DEFAULT '0',
  `TOTAL_OTHER_TRANSACTION` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credit` (
  ...
  `CREDIT_NOMINAL` double(15,2) DEFAULT '0',
...
CREATE TABLE `customer_product_disc` (
  ...
  `DISC_1` double(15,2) unsigned DEFAULT '0',
  `DISC_2` double(15,2) unsigned DEFAULT '0',
  `DISC_RP` double(15,2) unsigned DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `debt` (
  ...
  `DEBT_NOMINAL` double(15,2) DEFAULT '0',
...
CREATE TABLE `master_product` (
  ...
  `PRODUCT_BASE_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_RETAIL_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_BULK_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_WHOLESALE_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_PHOTO_1` varchar(50) DEFAULT '',
  `UNIT_ID` smallint(5) unsigned DEFAULT '0',
  `PRODUCT_STOCK_QTY` double(15,2) DEFAULT '0',
  `PRODUCT_LIMIT_STOCK` double(15,2) DEFAULT '0',
...
INSERT INTO `master_user` VALUES (1,'ADMIN','admin','ADMIN','1',1,1),(2,'ANITA','123456','ANITA CUUNET','',1,2);
...
CREATE TABLE `product_expiry` (
  ...
  CONSTRAINT `PROD_ID` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `master_product` (`PRODUCT_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchase_header` (
  ...
  `PURCHASE_TERM_OF_PAYMENT_DURATION` double(15,2) unsigned DEFAULT '0',
...
CREATE TABLE `return_purchase_detail` (
  ...
  `PRODUCT_ID` varchar(50) DEFAULT NULL,
  `PRODUCT_BASEPRICE` double(15,2) DEFAULT '0',
  `PRODUCT_QTY` double(15,2) DEFAULT '0',
  `RP_DESCRIPTION` varchar(100) DEFAULT NULL,
  `RP_SUBTOTAL` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `return_purchase_header` (
  ...
  `RP_TOTAL` double(15,2) DEFAULT '0',
...
CREATE TABLE `return_sales_detail` (
  ...
  `PRODUCT_ID` varchar(50) DEFAULT NULL,
  `PRODUCT_SALES_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_SALES_QTY` double(15,2) DEFAULT '0',
  `PRODUCT_RETURN_QTY` double(15,2) DEFAULT '0',
  `RS_DESCRIPTION` varchar(100) DEFAULT NULL,
  `RS_SUBTOTAL` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `return_sales_header` (
  ...
  `RS_TOTAL` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales_detail` (
  ...
  `SALES_INVOICE` varchar(30) DEFAULT NULL,
  `PRODUCT_ID` varchar(50) DEFAULT NULL,
  `PRODUCT_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_SALES_PRICE` double(15,2) DEFAULT '0',
  `PRODUCT_QTY` double(15,2) DEFAULT '0',
  `PRODUCT_DISC1` double(15,2) DEFAULT '0',
  `PRODUCT_DISC2` double(15,2) DEFAULT '0',
  `PRODUCT_DISC_RP` double(15,2) DEFAULT '0',
  `SALES_SUBTOTAL` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sales_header` (
  ...
  `SALES_TOTAL` double(15,2) DEFAULT '0',
  `SALES_DISCOUNT_FINAL` double(15,2) DEFAULT '0',
  `SALES_TOP` tinyint(3) unsigned DEFAULT '0',
  `SALES_TOP_DATE` date DEFAULT NULL,
  `SALES_PAID` tinyint(3) unsigned DEFAULT '0',
  `SALES_PAYMENT` double(15,2) unsigned DEFAULT '0',
  `SALES_PAYMENT_CHANGE` double(15,2) unsigned DEFAULT '0',
...
CREATE TABLE `sys_config_tax` (
  ...
  `AVERAGE_PENJUALAN_HARIAN` double(15,2) DEFAULT '0',
  `AVERAGE_PEMBELIAN_HARIAN` double(15,2) DEFAULT '0',
  `RASIO_TOLERANSI` double(15,2) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-09 23:53:45
