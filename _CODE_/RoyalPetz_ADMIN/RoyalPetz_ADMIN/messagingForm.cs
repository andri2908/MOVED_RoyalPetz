...
namespace RoyalPetz_ADMIN
{
    public partial class messagingForm : Form
    {
        ...
        private void loadMessageData()
        {
            ...
            string sqlCommand = "SELECT MM.ID, M.MODULE_ID, M.MODULE_NAME, MM.IDENTIFIER_NO AS IDENTIFIER_NO, MSG_CONTENT AS MESSAGE FROM MASTER_MESSAGE MM, MASTER_MODULE M WHERE MM.STATUS = 0 AND MM.MODULE_ID = M.MODULE_ID ORDER BY MM.ID LIMIT 10000";
