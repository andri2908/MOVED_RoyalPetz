...
namespace AlphaSoft
{
    public partial class SupplierHistoryForm : Form
    {
        ...
        private void loadSupplierHistory()
        {
            ...
            sqlCommand = "SELECT M.SUPPLIER_ID AS ID, IFNULL(M.SUPPLIER_FULL_NAME,'') AS SUPPLIER, H.LAST_SUPPLY AS 'TANGGAL' FROM MASTER_SUPPLIER M, SUPPLIER_HISTORY H WHERE H.SUPPLIER_ID = M.SUPPLIER_ID AND H.PRODUCT_ID = '" + kodeproduk + "' ORDER BY TANGGAL DESC";
