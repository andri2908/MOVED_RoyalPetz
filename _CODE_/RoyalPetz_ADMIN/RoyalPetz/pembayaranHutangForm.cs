...
namespace AlphaSoft
{
    public partial class pembayaranHutangForm : Form
    {
        ...
        public bool saveDataTransaction()
        {
            ...
            try
            {
                ...
                sqlCommand = "INSERT INTO PAYMENT_DEBT (DEBT_ID, PAYMENT_DATE, PM_ID, PAYMENT_NOMINAL, PAYMENT_DESCRIPTION, PAYMENT_CONFIRMED, PAYMENT_DUE_DATE) VALUES " +
                                    "(" + selectedDebtID+ ", STR_TO_DATE('" + paymentDateTime + "', '%d-%m-%Y'), "+paymentMethod+", " + gutil.validateDecimalNumericInput(paymentNominal) + ", '" + paymentDescription + "', " + paymentConfirmed + ", STR_TO_DATE('" + paymentDueDateTime + "', '%d-%m-%Y'))";
        ...
        private void pembayaranHutangForm_Deactivate(object sender, EventArgs e)
        {
