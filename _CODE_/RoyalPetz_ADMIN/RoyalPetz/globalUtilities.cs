...
namespace AlphaSoft
{
    class globalUtilities
    {
        ...
        public bool productExpirable(string productID)
        {
            bool result = false;
            int isExpired = 0;

            isExpired = Convert.ToInt32(DS.getDataSingleValue("SELECT PRODUCT_EXPIRABLE FROM MASTER_PRODUCT WHERE PRODUCT_ID = '" + productID + "'"));
