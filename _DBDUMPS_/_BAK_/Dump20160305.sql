...
CREATE TABLE `account_credit` (
  ...
  `credit_date_begin` date NOT NULL,
  `credit_date_end` date NOT NULL,
  `credit_nominal` double NOT NULL,
  `credit_pay_id` tinyint(4) unsigned NOT NULL,
  `credit_description` varchar(100) DEFAULT NULL,
...
CREATE TABLE `account_debt` (
  ...
  `debt_date_begin` date NOT NULL,
  `debt_date_end` date NOT NULL,
  `debt_nominal` double NOT NULL,
  `debt_pay_id` tinyint(3) unsigned NOT NULL,
  `debt_description` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`debt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `master_product` VALUES (1,'123',111,'aaa','aaa',100,101,100,100,'123.jpg',1,0,1,'-a01',1,'1',0),(2,'213',1111,'abab','aaaaaa',10,10,10,10,'213.jpg',0,0,1,'--00',1,' ',0),(3,'KRG001',123,'KARUNG SAK',' ',2000,10,10,10,' ',4,101,0,'--00',1,' ',0),(5,'SAK001',1234,'SAK',' ',1,10,10,10,' ',5,102,0,'--00',1,' ',0);
...
INSERT INTO `payment_method` VALUES (1,'TUNAI',NULL),(2,'BG BCA','BILYET GIRO BCA'),(3,'KK BCA','KARTU KREDIT BCA'),(4,'DB BCA','KARTU DEBIT BCA');
...
-- Dump completed on 2016-03-05 22:00:20
