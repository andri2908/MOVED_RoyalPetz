...
INSERT INTO `master_product` VALUES (1,'123',111,'aaa','aaa',100,101,100,100,'123.jpg',1,0,1,'-a01',1,'1',0),(2,'213',1111,'abab','aaaaaa',10,10,10,10,'213.jpg',0,0,1,'--00',1,' ',0),(3,'KRG001',123,'KARUNG SAK',' ',110,10,10,10,' ',4,99,0,'--00',1,' ',0),(5,'SAK001',1234,'SAK',' ',10,10,10,10,' ',5,98,0,'--00',1,' ',0);
...
INSERT INTO `products_mutation_header` VALUES (4,'11111',2,1,'2016-02-24',130,'1111'),(5,'123',1,2,'2016-02-25',230,'11'),(8,'1234',0,0,'2016-02-26',1320,''),(9,'12345',0,0,'2016-02-26',220,'');
...
CREATE TABLE `products_received_header` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `PR_INVOICE_UNIQUE` (`PR_INVOICE`),
  UNIQUE KEY `PM_INVOICE_UNIQUE` (`PM_INVOICE`),
...
-- Dump completed on 2016-03-02 15:43:14
